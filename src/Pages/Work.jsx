...
const works = [
  {
    id: 1,
    src: "https://images.pexels.com/photos/1037993/pexels-photo-1037993.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    title: "WORK 01",
    type: "Design",
    views: 123,
    likes: 45,
  ...
  {
    id: 6,
    src: "https://images.pexels.com/photos/733852/pexels-photo-733852.jpeg",
    title: "WORK 06",
    type: "Photography",
    views: 78,
    likes: 34,
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {displayedWorks.map((work) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-blue-500/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-center items-center text-white p-4">
                <h3 className="text-lg font-bold underline mb-1">
                  {work.title}
                </h3>
                <p className="text-sm mb-3">{work.type}</p>
